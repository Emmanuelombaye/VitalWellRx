...
export const metadata: Metadata = {
  title: 'Telehealth Consent | VitalWellRx',
  description:
...
export default function TelehealthConsentPage() {
  return (
    <LegalLayout
      ...
      lede="This Telehealth Consent explains how telehealth services may be provided through the VitaWellRx® platform. By using the VitaWellRx® Services, completing an assessment, submitting information, or proceeding with provider review, you consent to receive care through telehealth where permitted by applicable law."
    >
      <article>
        <p>
      ...
      <article>
        ...
        <p>
          VitaWellRx® uses reasonable administrative, technical, and physical safeguards designed to protect your
          information.
        </p>
      </article>
      <article>
