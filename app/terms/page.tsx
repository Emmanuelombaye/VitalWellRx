...
export const metadata: Metadata = {
  title: 'Terms of Use | VitalWellRx',
  description:
...
export default function TermsPage() {
  return (
    <LegalLayout
      title="Terms of Use"
      lede={`These Terms of Use govern your access to and use of the websites, online services, assessments, checkout flows, patient-facing technology, communications, and related non-clinical services provided by ${site.legalName} d/b/a VitaWell RX (the “Company,” “we,” “our,” or “us”) (collectively, the “Services”). By accessing or using the Services, you agree to these Terms.`}
    >
      <article>
        <h2>1. Introduction</h2>
        <p>
          These Terms of Use govern your access to and use of the websites, online services, assessments, checkout flows,
          patient-facing technology, communications, and related non-clinical services provided by {site.legalName}{' '}
          d/b/a VitaWell RX (the “Company,” “we,” “our,” or “us”) (collectively, the “Services”). By accessing or using
      ...
      <article>
        ...
        <p>
          ...
          provider must be authorized to practice in that state, and the dispensing pharmacy must be authorized to
          dispense and ship the prescribed medication to that state. Not every treatment, medication, provider, pharmacy,
          or fulfillment option is available in every listed state.
        </p>
      </article>
      <article>
        ...
        <ul>
          ...
          <li>
            Final treatment, formulation, dose, pharmacy, and pricing may vary based on provider review, patient-specific
            needs, pharmacy availability, and applicable law.
          </li>
          <li>
            Product imagery is illustrative and does not imply that the Company manufactures, compounds, dispenses, or
      ...
      <article>
        ...
        <p>
          ...
          <br />
          <a href={`tel:+1${contact.phone}`}>{contact.phoneDisplay}</a>
        </p>
      </article>
